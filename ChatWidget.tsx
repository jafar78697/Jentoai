...
const ChatWidget: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (response.ok) {
        // Some n8n workflows return a direct string, some return an object with 'output' or 'response'
        const data = await response.json();
        const aiResponse = typeof data === 'string' ? data : (data.output || data.response || data.text || "Protocol acknowledgement received, but no textual output was generated by the core.");
